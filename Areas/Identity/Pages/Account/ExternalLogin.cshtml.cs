...
namespace NET_290_291_T35.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        private readonly SignInManager<PetShopUser> _signInManager;
        private readonly UserManager<PetShopUser> _userManager;
        private readonly IUserStore<PetShopUser> _userStore;
        private readonly IUserEmailStore<PetShopUser> _emailStore;
        private readonly IEmailSender _emailSender;
        private readonly ILogger<ExternalLoginModel> _logger;

        public ExternalLoginModel(
            SignInManager<PetShopUser> signInManager,
            UserManager<PetShopUser> userManager,
            IUserStore<PetShopUser> userStore,
        ...
        private IUserEmailStore<PetShopUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<PetShopUser>)_userStore;
        }
    }
}
